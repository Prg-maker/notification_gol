...
export function CardPartidas() {
  return (
    <View style={styles.container}>
      
      <Text style={styles.nameCamp}>brasileirão</Text>
      ...
      <View style={{
        ...
        <View style={styles.home}>
          ...
          <Image style={styles.image} source={{uri:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8s7a-3FVjMLULGvs-jMrsHShCBZMvquIofw&usqp=CAU"}}/>
          <Text style={styles.nameTime}>Palmeiras</Text>
